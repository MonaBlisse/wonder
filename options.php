 ...
 *
 * If you are making your theme translatable, you should replace 'wonder'
...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('Header Meta', 'wonder'),
		'type' => 'heading');

// Standard Meta
	$options[] = array(
		'name' => __('Head ID', 'wonder'),
		'desc' => __("", 'wonder'),
		'id' => 'meta_headid',
		'std' => 'wonder',
		'type' => 'text');
	$options[] = array(
		'name' => __('Google Webmasters', 'wonder'),
		'desc' => __("Speaking of Google, don't forget to set your site up: <a href='http://google.com/webmasters' target='_blank'>http://google.com/webmasters</a>", 'wonder'),
		'id' => 'meta_google',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('Author Name', 'wonder'),
		'desc' => __('Populates meta author tag.', 'wonder'),
		'id' => 'meta_author',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('Mobile Viewport', 'wonder'),
		'desc' => __('Uncomment to use; use thoughtfully!', 'wonder'),
		'id' => 'meta_viewport',
...
// Icons
	$options[] = array(
		'name' => __('Site Favicon', 'wonder'),
		'desc' => __('', 'wonder'),
		'id' => 'head_favicon',
		'type' => 'upload');
	$options[] = array(
		'name' => __('Apple Touch Icon', 'wonder'),
		'desc' => __('', 'wonder'),
...
// App: Windows 8
	$options[] = array(
		'name' => __('App: Windows 8', 'wonder'),
		'desc' => __('Application Name', 'wonder'),
		'id' => 'meta_app_win_name',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'wonder'),
		'desc' => __('Tile Color', 'wonder'),
		'id' => 'meta_app_win_color',
		'std' => '',
		'type' => 'color');
	$options[] = array(
		'name' => __('', 'wonder'),
		'desc' => __('Tile Image', 'wonder'),
...
// App: Twitter
	$options[] = array(
		'name' => __('App: Twitter Card', 'wonder'),
		'desc' => __('twitter:card (summary, photo, gallery, product, app, player)', 'wonder'),
		'id' => 'meta_app_twt_card',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'wonder'),
		'desc' => __('twitter:site (@username of website)', 'wonder'),
		'id' => 'meta_app_twt_site',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'wonder'),
		'desc' => __("twitter:title (the user's Twitter ID)", 'wonder'),
		'id' => 'meta_app_twt_title',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'wonder'),
		'desc' => __('twitter:description (maximum 200 characters)', 'wonder'),
		'id' => 'meta_app_twt_description',
		'std' => '',
		'type' => 'textarea');
	$options[] = array(
		'name' => __('', 'wonder'),
		'desc' => __('twitter:url (url for the content)', 'wonder'),
		'id' => 'meta_app_twt_url',
		'std' => '',
		'type' => 'text');
...
// App: Facebook
	$options[] = array(
		'name' => __('App: Facebook', 'wonder'),
		'desc' => __('og:title', 'wonder'),
		'id' => 'meta_app_fb_title',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'wonder'),
		'desc' => __('og:description', 'wonder'),
		'id' => 'meta_app_fb_description',
		'std' => '',
		'type' => 'textarea');
	$options[] = array(
		'name' => __('', 'wonder'),
		'desc' => __('og:url', 'wonder'),
		'id' => 'meta_app_fb_url',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'wonder'),
		'desc' => __('og:image', 'wonder'),
